...
def spiciest_foods(spicy_foods)
  spicy_foods.filter{|spicy_food| spicy_food[:heat_level
    ]>5}
end
...
def print_spicy_foods(spicy_foods)
  spicy_foods.each do |food|
    ...
    puts "#{spicy_foods[:name]} (#{spicy_foods[:cuisine]}) | Heat_Level: #{heat_level}"
  end
end
...
def average_heat_level(spicy_foods)
  total_heat_level = spicy_foods.map { |spicy_food| spicy_food[:heat_level]}.sum / spicy_foods.size
end
